...
cam = Camera(Vector3(0, 0, 0), screenDistance=400, screenSize=Vector2(imageSize[0] * 4, imageSize[1] * 4), screenRes=Vector2(imageSize[0], imageSize[1]), bg=Color(230, 255, 255))
